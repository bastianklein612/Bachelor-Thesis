...
Chapter [\ref{ch:background}]  introduces foundational concepts and techniques we use and reference in our work followed by an exploration of existing research papers which are concerned with closely related problems.
