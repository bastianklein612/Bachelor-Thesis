...
Reinforcement Learning(RL), besides supervised and unsupervised learning, is one of the three major branches in the vast field of Machine Learning.
...
The principle of RL is inspired by behavioral psychology, where learning is driven by the consequences of the actions taken \parencite{FIND AUTHOR}\todo{Cite author for behavioral psych.}.
...
The agents policy is continually updated during the learning process, always trying to improve the action sequences towards a higher expected reward.
