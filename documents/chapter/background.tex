...
In this chapter we will introduce the terms and concepts used in the context of this thesis and which are required to understand the further content.
...
In MATLAB, the \emph{Reinforcement Learning} toolbox offers several different algorithms to choose from, including DDPG, TR3, PPO, SAC and TRPO.
...
A PG method as well, \textbf{PPO} employs the actor-critic architecture to train a NN on finding an optimal policy.
