...
\begin{figure}[h]
	\centerline{\includegraphics[scale=0.065]{phantomX_III_overview}}
	\caption[Trossen Robotics PhantomX MKIII]{PhantomX MKIII hexapod, predecessor of the MKIV used in this thesis [\cite{PhantomX_MKIII}]}
	\label{figure: PhantomX MKIII}
\end{figure}
\todo{MALTE: Add image of leg architecture}
