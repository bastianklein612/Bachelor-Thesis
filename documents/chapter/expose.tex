...
To support our research on hexapod robots, we aim to capitalize on these.
...
This includes the modeling of kinematics, friction as well as collision detection.
...
Furthermore, the surrounding MATLAB software framework enables the future use of tools from different domains, such as control/ learning algorithm development or code generation for hardware.
