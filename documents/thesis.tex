...
\newcommand{\printnumber}{504 501}

\newcommand{\printtitle}{Leveraging MATLAB Simulink for Hexapod Robotics:\\Simulation, Control and Learning}
\newcommand{\printalttitle}{Verwendung von MATLAB Simulink in der Hexapod-Robotik: Simulation, Steuerung und Lernen}
...
\begin{titlepage}
	\input{chapter/videoResources.tex}
\end{titlepage}
